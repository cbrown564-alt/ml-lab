  ...
  cards: [
    {
      ...
      diagnosis: "With enough weights the network can memorise every training point — including the noisy ones — instead of learning the smooth rule. The widening train-test gap is the signature.",
      repair: "Reduce capacity (fewer units/layers), regularise (weight decay, dropout), or stop training early — keep capacity for the signal, not the noise.",
      boundary: "Too little capacity underfits — it can't represent the real shape at all. The goal isn't minimal capacity, it's the right amount plus regularisation.",
    },
    {
      ...
      repair: "Put a nonlinearity (tanh, ReLU, …) between every pair of layers — that's the one ingredient that turns stacked neurons into an expressive network.",
