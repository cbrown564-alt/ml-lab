  ...
  cards: [
    {
      ...
      diagnosis: "The selection saw every row, including the ones each fold later 'holds out', so the features were chosen partly to fit the test folds. Is the model skilled, or did the pipeline peek?",
