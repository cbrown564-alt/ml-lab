  ...
  datasets: [
    {
      id: "gd-zigzag",
      label: "Sensible data",
      points: fixturePoints("gd-zigzag"),
  ...
  scenarios: [
    {
      ...
      prompt:
        "The flat line knows nothing. Press play and watch it learn: each step reads the slope of the loss surface and steps downhill. The first step overshoots, so the line zigzags across the valley as it homes in — yet every step lands lower than the last. The dashed line is the destination, the least-squares fit. Lift the fog and watch the path bounce its way down.",
      datasetId: "gd-zigzag",
      params: { learningRate: 0.06 },
    },
    {
      id: "too-timid",
      title: "Too timid",
