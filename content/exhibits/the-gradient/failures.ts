  ...
  cards: [
    {
      ...
      boundary: "On a convex surface — a single bowl — there's only one basin, so a vanishing gradient really is the global answer. The trap needs a non-convex landscape.",
    },
    {
      ...
      symptom: "The steps shrink to almost nothing and progress crawls — the optimiser looks stuck even though it isn't at an optimum.",
