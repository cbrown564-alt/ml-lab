  ...
  cards: [
    {
      ...
      trigger: "Train logistic regression on a problem whose true boundary is curved — XOR, or one class encircling another.",
      symptom: "Accuracy sits near chance and the boundary slices the plane uselessly; no setting of the weights helps.",
      diagnosis: "Logistic regression draws one straight line (the score is linear in the features) — it's too rigid to represent a curved boundary. High bias, and the optimiser isn't at fault.",
