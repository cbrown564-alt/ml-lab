  ...
  cards: [
    {
      ...
      diagnosis: "The model has no independent notion of truth — it reproduces whatever pattern is in the examples, faithfully including the skew. Good fit to biased data is exactly the problem.",
      repair: "Fix the data, not the model: collect representative, correctly-labelled examples. No algorithm recovers a signal the data doesn't contain.",
    ...
    },
    {
      ...
      boundary: "How many is enough depends on how complex the rule is — a straight line needs only a few points; a face recogniser needs millions.",
    },
  ],
};
