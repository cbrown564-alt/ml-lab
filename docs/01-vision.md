...
2. **Exhibits are cinematic, the lab is calm.** Concept pages can be immersive and theatrical (scroll-driven sequences, full-bleed visuals, character moments). Navigation, the graph explorer, and assessment surfaces are quiet, fast, and utilitarian. Contrast is the design system.
...
4. **Characters as guides, not mascots-for-kids.** Visual characters (AI-generated, art-directed) personify domains and recurring ideas — giving abstract machinery a face and a voice (ElevenLabs). They are styled for adults: think field-guide illustrations or scientific patron figures, not cartoon critters. (Exact treatment is an open direction question.)
